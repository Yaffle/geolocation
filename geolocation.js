...
button.addEventListener("click", function (event) {
  try {
    ...
    watchId = window.navigator.geolocation.watchPosition(function (position) {
      ...
      document.getElementById("error").innerHTML = code(error.code) + ":" + error.message;
    }, {
